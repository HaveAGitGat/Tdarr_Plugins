    ...
    inputs: [
        {
            ...
            tooltip: 'Choose the subtitles languages you want to keep. Three letter format.'
...
var removeNyLanguage = function (args) {
    ...
    var langTagsMaster = refineLangTags(languages, langTags);
    args.variables.ffmpegCommand.streams.forEach(function (stream) {
        ...
        args.jobLog("Removing Subtitles at index ".concat(stream.index, " Unwanted Language"));
