    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                args.jobLog("Downloading working file: ".concat(filePath));
                if (!args.shouldDownloadWorkingFile) {
                    throw new Error("shouldDownloadWorkingFile not available - requires Tdarr ".concat(details().requiresVersion, " or later"));
                }
                return [4 /*yield*/, args.shouldDownloadWorkingFile(filePath)];
            case 1:
                _a.sent();
