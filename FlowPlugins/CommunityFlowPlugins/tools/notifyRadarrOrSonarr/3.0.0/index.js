...
/* -------------- helpers -------------- */
var parseSxxEyy = function (fileName) {
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                match = Array.isArray(eps.data)
                    ...
                    function (e) { return Number(e.seasonNumber) === season && Number(e.episodeNumber) === episode; })
                    : null;
                if (!match) {
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                unmonitorAfterRefresh = args.inputs.unmonitor_after_refresh === true
                ...
                arrApp = arr === 'radarr'
                    ? {
                        ...
                        delegates: {
                            ...
                            buildRefreshRequestData: function (id) { return JSON.stringify({ name: 'RefreshMovie', movieIds: [id] }); },
                        },
                    }
                    : {
                        name: arr,
                        ...
                        delegates: {
                            ...
                            buildRefreshRequestData: function (id) { return JSON.stringify({ name: 'RefreshSeries', seriesId: id }); },
                        },
                    };
            ...
            case 4:
                ...
                if (!unmonitorAfterRefresh) return [3 /*break*/, 12];
                _e.label = 5;
            case 5:
                _e.trys.push([5, 11, , 12]);
                if (!(arr === 'radarr')) return [3 /*break*/, 7];
                return [4 /*yield*/, unmonitorRadarr(args, arrApp, id)];
            case 6:
                _e.sent();
                return [3 /*break*/, 10];
            case 7:
                srcPath = originalFileName || currentFileName;
                sxe = parseSxxEyy(srcPath);
                if (!sxe) return [3 /*break*/, 9];
                return [4 /*yield*/, unmonitorSonarrEpisode(args, arrApp, id, sxe.season, sxe.episode)];
            case 8:
                _e.sent();
                return [3 /*break*/, 10];
            case 9:
                args.jobLog("Sonarr: cannot unmonitor \u2013 SxxEyy not detected in \"".concat((0, fileUtils_1.getFileName)(srcPath), "\""));
                _e.label = 10;
