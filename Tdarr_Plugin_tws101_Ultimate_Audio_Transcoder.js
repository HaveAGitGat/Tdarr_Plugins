...
//Setup Additional Variables to prepare to trascode, streams will be sorted into good streams and possible streams. 
  ...
  copycreate(lan1gstreams, lan1pstreams, lan1);
  if (trigger === true) {
    attemptMakeStreamlan1triggered = true;
  }
  copycreate(lan2gstreams, lan2pstreams, lan2);
  if (trigger === true) {
    attemptMakeStreamlan2triggered = true;
  }
  copycreate(lan3gstreams, lan3pstreams, lan3);
  if (trigger === true) {
    attemptMakeStreamlan3triggered = true;
  }
  copycreate(lan4gstreams, lan4pstreams, lan4);
  if (trigger === true) {
    attemptMakeStreamlan4triggered = true;
  }
  copycreate(lan5gstreams, lan5pstreams, lan5);
  if (trigger === true) {
    attemptMakeStreamlan5triggered = true;
  }
  copycreate(lan6gstreams, lan6pstreams, lan6);
  if (trigger === true) {
    attemptMakeStreamlan6triggered = true;
  }
  copycreate(lan7gstreams, lan7pstreams, lan7);
  if (trigger === true) {
    attemptMakeStreamlan7triggered = true;
  }
  copycreate(lan8gstreams, lan8pstreams, lan8);
  if (trigger === true) {
    attemptMakeStreamlan8triggered = true;
  }
  copycreate(lan101gstreams, lan101pstreams, lan101);
  if (trigger === true) {
    attemptMakeStreamlan101triggered = true;
  }
  if (inputs.keepundefined === true) {
    copycreate(Undgstreams, Undpstreams, "Undefined");
    if (trigger === true) {
