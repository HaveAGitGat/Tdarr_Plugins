// tdarrSkipTest
const details = () => ({
  id: 'Tdarr_Plugin_NG56_EatPrilosec_extract_subs_by_type_srt',
  Stage: 'Pre-processing',
  Name: 'Extract embedded SubRip (subrip) to .srt and optionally remove them',
  Type: 'Video',
  Operation: 'Transcode',
  Description: 'This plugin extracts embedded SubRip subs \n\n ',
  Version: '1.00',
...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  for (let i = 0; i < subsArr.length; i += 1) {
    ...
    if (subStream.codec_name.toLowerCase().includes('subrip') || subStream.codec_name.toLowerCase().includes('srt')) {
