// tdarrSkipTest
const details = () => ({
  id: 'Tdarr_Plugin_NG56_EatPrilosec_extract_subs_by_type_hdmv_pgs_subtitle',
  Stage: 'Pre-processing',
  Name: 'Extract embedded PGS subtitles (hdmv_pgs_subtitle) to specified file extension and optionally remove them',
  Type: 'Video',
  Operation: 'Transcode',
  Description: 'This plugin extracts embedded PGS subs to the specified extension  \n\n ',
  Version: '1.00',
...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  for (let i = 0; i < subsArr.length; i += 1) {
    ...
    if (subStream.codec_name.toLowerCase().includes('hdmv_pgs_subtitle')) {
