...
// forked tehNiemer Tdarr_Plugin_TN10_SUBS which this is based on this is a tws101 fork
// This was forked as its merge request was removed, and it is a good plugin
const details = () => ({
  id: 'Tdarr_Plugin_tws101_Extract_Copy_Remove_Subtitles',
  Stage: 'Pre-processing',
  Name: 'tws101 - Extract/Copy/Remove embedded subtitles',
  Type: 'Subtitle',
  Operation: 'Transcode',
...
const plugin = (file, librarySettings, inputs, otherArguments) => {
  ...
  if (cmdRemove === '' && cmdExtract === '' && !bolRemoveAll) {
    ...
    response.infoLog += '☒ Working on the above!\n';
  }
