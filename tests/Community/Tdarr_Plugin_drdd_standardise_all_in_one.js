  ...
  },
  {
    ...
    output: {
      ...
      infoLog: '☒ Will convert multi channel audio to AC3\n'
        ...
        + '• Maximum Bitrate: 1972\n',
      processFile: true,
      preset: '-hwaccel cuda,-map 0 -map -0:d -c:v hevc_nvenc -cq:v 19 -b:v 1517k -minrate 1061k -maxrate 1972k -bufsize 1517k -spatial_aq:v 1 -rc-lookahead:v 32 -c:a copy -c:a:0 ac3 -c:s copy -max_muxing_queue_size 4096',
      reQueueAfter: false,
    },
  },
  {
