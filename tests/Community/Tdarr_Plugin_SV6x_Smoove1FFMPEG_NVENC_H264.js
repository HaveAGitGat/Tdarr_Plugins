...
const tests = [
  ...
  },
  {
    ...
    output: {
      ...
      FFmpegMode: true,
      reQueueAfter: true,
      preset: '-hwaccel cuda,-map 0 -c:v h264_nvenc -preset fast -crf 23 -b:v 3058k -minrate 2140k -maxrate 3975k -bufsize 3058k -c:a copy -c:s copy -max_muxing_queue_size 9999 -pix_fmt yuv420p ',
      container: '.mkv',
    },
  },
  {
  ...
  },
  {
    ...
    output: {
      ...
      FFmpegMode: true,
      reQueueAfter: true,
      preset: '-hwaccel cuda,-map 0 -c:v h264_nvenc -preset fast -crf 23 -b:v 1526k -minrate 1068k -maxrate 1983k -bufsize 1526k -c:a copy -c:s copy -max_muxing_queue_size 9999 -pix_fmt yuv420p ',
      container: '.mkv',
    },
  },
  {
