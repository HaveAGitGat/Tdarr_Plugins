...
const tests = [
...

  {
    ...
    output: {
      ...
      FFmpegMode: true,
      reQueueAfter: true,
      infoLog: '☒Audio track is 6 channel, no 2 channel exists. Creating 2 channel "Anglais E-AC3 2.0 - 2.0" from 6 channel. \n'
      + '☒Audio track is 6 channel, no 2 channel exists. Creating 2 channel "Français E-AC3 2.0 - 2.0" from 6 channel. \n'
      + '☒Audio track is 6 channel, no 2 channel exists. Creating 2 channel "Anglais E-AC3 2.0 - 2.0" from 6 channel. \n',
      preset: ', -map 0 -c:v copy -c:a copy -map 0:3 -c:a:2 aac -ac 2 -metadata:s:a:2 title="Anglais E-AC3 2.0 - 2.0" -metadata:s:a:2 language="eng" -map 0:4 -c:a:3 aac -ac 2 -metadata:s:a:3 title="Français E-AC3 2.0 - 2.0" -metadata:s:a:3 language="fre" -map 0:5 -c:a:4 aac -ac 2 -metadata:s:a:4 title="Anglais E-AC3 2.0 - 2.0" -metadata:s:a:4 language="eng"  -strict -2 -c:s copy -max_muxing_queue_size 9999 ',
    },
  },

  {
    ...
    output: {
      ...
      FFmpegMode: true,
      reQueueAfter: true,
      infoLog: '☒Audio track is 6 channel, no 2 channel exists. Creating 2 channel "Français E-AC3 2.0 - 2.0" from 6 channel. \n',
      preset: ', -map 0 -c:v copy -c:a copy -map 0:4 -c:a:3 aac -ac 2 -metadata:s:a:3 title="Français E-AC3 2.0 - 2.0" -metadata:s:a:3 language="fre"  -strict -2 -c:s copy -max_muxing_queue_size 9999 ',
    },
  },
  ...
  // DTS 6.1 (7 channel) with existing 6ch but no 2ch - should create 2ch from both 6ch and 7ch
  {
    ...
    output: {
      ...
      infoLog: '☒Audio track is 7 channel (6.1), no 2 channel exists. Creating 2 channel from 7 channel. \n'
        ...
        + '☒Audio track is 6 channel, no 2 channel exists. Creating 2 channel "Français E-AC3 2.0 - 2.0" from 6 channel. \n'
        + '☒Audio track is 6 channel, no 2 channel exists. Creating 2 channel "Anglais E-AC3 2.0 - 2.0" from 6 channel. \n',
      preset: ', -map 0 -c:v copy -c:a copy -map 0:1 -c:a:0 aac -ac 2 -metadata:s:a:0 title="2.0" -map 0:2 -c:a:1 aac -ac 2 -metadata:s:a:1 title="Anglais E-AC3 2.0 - 2.0" -metadata:s:a:1 language="eng" -map 0:3 -c:a:2 aac -ac 2 -metadata:s:a:2 title="Anglais E-AC3 2.0 - 2.0" -metadata:s:a:2 language="eng" -map 0:4 -c:a:3 aac -ac 2 -metadata:s:a:3 title="Français E-AC3 2.0 - 2.0" -metadata:s:a:3 language="fre" -map 0:5 -c:a:4 aac -ac 2 -metadata:s:a:4 title="Anglais E-AC3 2.0 - 2.0" -metadata:s:a:4 language="eng"  -strict -2 -c:s copy -max_muxing_queue_size 9999 ',
    },
  },
];
